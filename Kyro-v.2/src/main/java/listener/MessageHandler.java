...
public class MessageHandler {
    ...
    @SubscribeEvent
    public void messageReaction(@Nonnull MessageReactionAddEvent evt) {
    ...
    @SubscribeEvent
    public void messageDelete(@Nonnull MessageDeleteEvent evt) {
        switch (evt.getChannelType()) {
    ...
    @SubscribeEvent
    public void reactionRemove(@Nonnull MessageReactionRemoveEvent evt) {
        evt.retrieveUser().submit().thenAccept(u -> {
            if (!u.isBot()) {
